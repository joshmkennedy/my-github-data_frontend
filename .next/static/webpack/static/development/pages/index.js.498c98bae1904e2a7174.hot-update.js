...
var LineGraph = function LineGraph(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", {
    viewBox: "0 0 ".concat(w, " ").concat(h + h * 0.1),
    className: className,
    __source: {
    ...
    var xPos = index !== outputLabels.length - 1 ? index * w / 2 : index * w / 2 - w * 0.1;
...
})(["width:100%;height:auto;background:white;.grid{stroke:black;stroke-width:3;}.increment-line{stroke:black;stroke-width:0.2;}text{font-size:0.1em;}"]));

/***/ })

})
//# sourceMappingURL=index.js.498c98bae1904e2a7174.hot-update.js.map