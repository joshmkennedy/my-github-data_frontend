...
var LineGraph = function LineGraph(_ref) {
  ...
  var w = viewBox.w,
      h = viewBox.h; //const arrayMiddle = dataset => dataset.map(x => console.log(x));

  var newXLabels = xLabels.map(function (label) {
    return {
      date: label.week
    };
  });
...
//# sourceMappingURL=index.js.3cfbf180a0c79b7f3772.hot-update.js.map