...
var LineGraph = function LineGraph(_ref) {
  ...
  var threeLabels = function threeLabels(arr, labelCount) {
    return arr.map(function (label, index) {
      var unit = arr.length / labelCount;
      console.log(unit, arr.length);
      return arr[Math.floor(unit * index)];
    });
  };
...
//# sourceMappingURL=index.js.5e5145eb1842961dbd92.hot-update.js.map